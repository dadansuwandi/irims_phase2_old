 ...
 */
class risk_item_model extends MY_Model {
	
	private $ci;
	protected $table = 'mst_risk_items';
    protected $risk_directorate_table = 'mst_risk_directorates';
    protected $risk_table = 'mst_risks';
    protected $risk_category_table = 'mst_risk_categories';
    ...
    function get_by_risk_directorate($id) {
        $this->db->select($this->risk_directorate_table . '.*, ' . $this->risk_directorate_table . '.name AS risk_directorate_name')
                ->join($this->risk_directorate_table, $this->risk_directorate_table . '.id = ' . $this->table . '.risk_directorate_id', 'left');
        return parent::get_by_id($id);
    }

    function get_by_risk($id) {
        $this->db->select($this->risk_table . '.*, ' . $this->risk_table . '.name AS risk_name')
                ->join($this->risk_table, $this->risk_table . '.id = ' . $this->table . '.risk_id', 'left');
        return parent::get_by_id($id);
    }

    function get_by_risk_category($id) {
        $this->db->select($this->risk_category_table . '.*, ' . $this->risk_category_table . '.name AS risk_name')
                ->join($this->risk_category_table, $this->risk_category_table . '.id = ' . $this->table . '.risk_category_id', 'left');
        return parent::get_by_id($id);
    }
