...
/**
 * Risk Impact Category Model
 * 
 * @package App
 * @category Model
 * @author Wildan Sawaludin
 */
class risk_impact_category_model extends MY_Model {
	
	private $ci;
	protected $table = 'mst_risk_impact_categories';
	...
	function create_code() {
        ...
        $nextNo = substr('00'.$nextNo, -3) . '/RIC/' . date('m') . '/' . date('Y');
        return $nextNo;
    }
