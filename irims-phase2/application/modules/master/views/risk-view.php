<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
Risk Category <small><?php echo $this->config->item('page_title'); ?></small>
</h3>
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		?>
		<li>
			<a href="<?php echo site_url('master/risk/index'); ?>">Risk Category</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
		...
		<li>
			<a href="<?php echo site_url('master/risk/view/' . $this->uri->segment(4)); ?>">View</a>
		</li>
		<?php
		}
		?>
	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-table"></i>Risk Category
				</div>
				<!--
				<div class="tools">
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="risk_category" value="<?php echo !empty($risk_category->name) ? $risk_category->name : ''; ?>" data-required="1" class="form-control" readonly="readonly"/>
							</div>
						</div>
						<!--
						<div class="form-group">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-9">
								<!--<a href="<?php /*echo site_url('master/risk/edit/' . $row->id);*/ ?>" title="View" class="btn green">Edit</i></a>-->
								<a href="<?php echo site_url('master/risk/index'); ?>" title="View" class="btn green">Back</i></a>
								<a href="<?php echo site_url('master/risk/index'); ?>" title="View" class="btn default">Cancel</i></a>
							</div>
						</div>
					</div>
				</form>
