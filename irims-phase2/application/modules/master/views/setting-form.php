					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="website" value="<?php echo !empty($website) ? $website : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="owner" value="<?php echo !empty($owner) ? $owner : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-9">
								<?php
                                    $image = '';
                                    if(!empty($photo)){
                                        $image = base_url().'uploads/setting/'. $photo;
                                    }else{
                                ...
                                <br/>
                                <br/>
								<input type="file" value="" id="userfile" name="userfile"/>
							</div>
						</div>
						<div class="form-group">
