<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
Risk Impact Category <small><?php echo $this->config->item('page_title'); ?></small>
</h3>
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		?>
		<li>
			<a href="<?php echo site_url('master/risk_impact_category/index'); ?>">Risk Impact Category</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="<?php echo site_url('master/risk_impact_category/add'); ?>">Add</a>
		</li>
		<?php
		...
		<li>
			<a href="<?php echo site_url('master/risk_impact_category/edit/' . $this->uri->segment(4)); ?>">Edit</a>
		</li>
		<?php
		...
		<li>
			<a href="<?php echo site_url('master/risk_impact_category/view/' . $this->uri->segment(4)); ?>">View</a>
		</li>
		<?php
		}
		?>
	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-table"></i>Risk Impact Category
				</div>
				<!--
				<div class="tools">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-9">
								<!--<a href="<?php /*echo site_url('master/risk_impact_category/edit/' . $row->id);*/ ?>" title="View" class="btn green">Edit</i></a>-->
								<a href="<?php echo site_url('master/risk_impact_category/index'); ?>" title="View" class="btn green">Back</i></a>
								<a href="<?php echo site_url('master/risk_impact_category/index'); ?>" title="View" class="btn default">Cancel</i></a>
							</div>
						</div>
					</div>
				</form>
