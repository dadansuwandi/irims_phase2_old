<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
Indicator <small><?php echo $this->config->item('page_title'); ?></small>
</h3>
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		?>
		<li>
			<a href="<?php echo site_url('master/indicator/index'); ?>">Indicator</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="<?php echo site_url('master/indicator/add'); ?>">Add</a>
		</li>
		<?php
		...
		<li>
			<a href="<?php echo site_url('master/indicator/edit/' . $this->uri->segment(4)); ?>">Edit</a>
		</li>
		<?php
		...
		<li>
			<a href="<?php echo site_url('master/indicator/view/' . $this->uri->segment(4)); ?>">View</a>
		</li>
		<?php
		}
		?>
	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-table"></i>Indicator
				</div>
				<!--
				<div class="tools">
			...
			<div class="portlet-body form">
				...
				<form id="form_sample_3" class="form-horizontal" method="post" enctype="multipart/form-data">
					<div class="form-body">
						...
						<!-- <div class="form-group">
							<label class="control-label col-md-2">Alias <span class="required">
							* </span>
							</label>
							<div class="col-md-9">
								<input type="text" name="name" value="<?php //echo !empty($row->name_alias) ? $row->name_alias : ''; ?>" data-required="1" class="form-control" readonly="readonly"/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="risk_item" value="<?php echo !empty($risk_item->name) ? $risk_item->name : ''; ?>" data-required="1" class="form-control" readonly="readonly"/>
							</div>
						</div>
						<!--
						<div class="form-group">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-9">
								<!--<a href="<?php /*echo site_url('master/indicator/edit/' . $row->id);*/ ?>" title="View" class="btn green">Edit</i></a>-->
								<a href="<?php echo site_url('master/indicator/index'); ?>" title="View" class="btn green">Back</i></a>
								<a href="<?php echo site_url('master/indicator/index'); ?>" title="View" class="btn default">Cancel</i></a>
							</div>
						</div>
					</div>
				</form>
