					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="risk_register_number" value="<?php echo !empty($risk_register_number) ? $risk_register_number : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<select class="form-control select2me" name="risk_directorate_id">
									<?php foreach($risk_directorate as $key=>$val): ?>
									<?php if($key==$risk_directorate_id) { ?>
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<select class="form-control select2me" name="risk_id">
