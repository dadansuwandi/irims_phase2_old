...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo site_url('master/unit/view/' . $this->uri->segment(4)); ?>">View</a>
		</li>
		<?php
		}
		?>
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="checkbox" name="is_kantor_pusat" <?php echo !empty($row->is_kantor_pusat) ? "checked='checked'" : ''; ?> data-required="1" class="form-control"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="checkbox" name="is_kantor_pusat" <?php echo !empty($row->showin_dashboard) ? "checked='checked'" : ''; ?> data-required="1" class="form-control"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="lat" value="<?php echo !empty($row->sorting) ? $row->sorting : ''; ?>" data-required="1" class="form-control" readonly="readonly"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="lat" value="<?php echo !empty($row->lat) ? $row->lat : ''; ?>" data-required="1" class="form-control" readonly="readonly"/>
							</div>
						</div>
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="lon" value="<?php echo !empty($row->lon) ? $row->lon : ''; ?>" data-required="1" class="form-control" readonly="readonly"/>
							</div>
						</div>
						<div class="form-group">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-9">
								<a href="<?php echo site_url('master/unit/edit/' . $row->id); ?>" title="View" class="btn green">Edit</i></a>
								<a href="<?php echo site_url('master/unit/index'); ?>" title="View" class="btn default">Cancel</i></a>
							</div>
						</div>
					</div>
				</form>
