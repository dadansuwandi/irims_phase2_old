...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo site_url('master/status/add'); ?>">Add</a>
		</li>
		<?php
		...
		<li>
			<a href="<?php echo site_url('master/status/edit/' . $this->uri->segment(4)); ?>">Edit</a>
		</li>
		<?php
		...
		<li>
			<a href="<?php echo site_url('master/status/view/' . $this->uri->segment(4)); ?>">View</a>
		</li>
		<?php
		}
		?>
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-2 col-md-9">
								<!--<a href="<?php /*echo site_url('master/status/edit/' . $row->id);*/ ?>" title="View" class="btn green">Edit</i></a>-->
								<a href="<?php echo site_url('master/status/index'); ?>" title="View" class="btn green">Back</i></a>
								<a href="<?php echo site_url('master/status/index'); ?>" title="View" class="btn default">Cancel</i></a>
							</div>
						</div>
					</div>
				</form>
