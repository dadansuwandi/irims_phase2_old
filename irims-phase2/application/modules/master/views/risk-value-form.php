					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<select class="form-control select2me" name="risk_probability_id">
									<?php foreach($risk_probability as $key=>$val): ?>
									<?php if($key==$risk_probability_id) { ?>
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<select class="form-control select2me" name="risk_impact_id">
									<?php foreach($risk_impact as $key=>$val): ?>
									<?php if($key==$risk_impact_id) { ?>
									<option value="<?php echo !empty($key) ? $key : ''; ?>" selected="selected"><?php echo !empty($val) ? $val : ''; ?></option>
									<?php } else { ?>
									<option value="<?php echo !empty($key) ? $key : ''; ?>"><?php echo !empty($val) ? $val : ''; ?></option>
									<?php } ?>
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<select class="form-control select2me" name="risk_level_id">
									<?php foreach($risk_level as $key=>$val): ?>
									<?php if($key==$risk_level_id) { ?>
									<option value="<?php echo !empty($key) ? $key : ''; ?>" selected="selected"><?php echo !empty($val) ? $val : ''; ?></option>
									<?php } else { ?>
									<option value="<?php echo !empty($key) ? $key : ''; ?>"><?php echo !empty($val) ? $val : ''; ?></option>
									<?php } ?>
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="rangking" value="<?php echo !empty($rangking) ? $rangking : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								...
								<textarea name="description" rows="3" value="<?php echo !empty($description) ? $description : ''; ?>" data-required="1" class="form-control"><?php echo !empty($description) ? $description : ''; ?></textarea>
							</div>
						</div>
					</div>
