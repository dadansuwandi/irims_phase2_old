...
<div class="row margin-bottom-20">
	<div class="col-md-12">
		<p align="center">
			...
			<font size="4"><b>SEMUA CABANG</b></font> <br>
				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							?>
							<td rowspan="<?php echo count($row['data'])?>" style="vertical-align:top !important"><?php echo $risk_rank_mitigasi[0]; ?></td>
							<td rowspan="<?php echo count($row['data'])?>" style="vertical-align:top !important"><?php echo $risk_rank_mitigasi[1]; ?></td>
							<?php }?>
							<?php endif;?>
								...
								<?php
									if($mitigation){
										...
										for ($i=0; $i <= count($mitigation)-1; $i++) { 
											...
											echo $this->risk_pic_model->get_by_id($mitigation[$i]->PIC_KANTOR_PUSAT_ID)->name;
										}
										//echo "</ol>";
									}else{
										echo "Not Set";
							...
							<?php if($temp==1){?>
							<td rowspan="<?php echo count($row['data'])?>" style="vertical-align:top !important"><?php echo $risk_item->description; ?></td>
							<?php $temp++;}?>
							<td>
								<?php
