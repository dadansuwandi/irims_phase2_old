				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<td><a href="<?php echo site_url('report/risk_assessment_report/register_card_detail/' . $d->RISK_ITEM_ID); ?>" target="_blank"><font color="blue"><i class="fa fa-search" aria-hidden="true"></i><?php echo 'view'?></font></a></td>
						</tr>
						<?php
							}
						?>
