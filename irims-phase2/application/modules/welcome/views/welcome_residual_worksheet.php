...
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
Residual Top Risk <small>Integrated Risk Management System (IRIMS)</small>
</h3>
<div class="page-bar">
...
<div class="row">
	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<a class="dashboard-stat red-haze" href="#">
			<div class="visual">
				<i class="fa fa-file-o"></i>
			</div>
			<div class="details">
				<div class="number">
					<?php echo $summary_teridentifikasi;?>
				</div>
				<div class="desc">
					Total Risk Event
				</div>
					...
					<div class="tab-pane active" id="tab_top_10">
						<div class="svg-container" style="font-size:10px !important;">
							<svg version="1.1" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" id="svg-radar-top"> -->
							    ...
							    <!-- separator lines -->
							   <!--  <line x1="250" y1="250" x2="450" y2="250" style="stroke:white;stroke-width:2" />
							    <line x1="250" y1="250" x2="315" y2="450" style="stroke:white;stroke-width:2" />
							    <line x1="250" y1="250" x2="50" y2="395" style="stroke:white;stroke-width:2" />
							    <line x1="250" y1="250" x2="50" y2="105" style="stroke:white;stroke-width:2" />
							    <line x1="250" y1="250" x2="310" y2="50" style="stroke:white;stroke-width:2" /> -->
							   	
							   	<!-- radar legend -->
							   <!-- 	<text x="407" y="421" fill="black" transform="rotate(300, 407, 421)" style="font-weight:bold;font-size:13px;" opacity="0.9">SAFETY & SECURITY RISK</text>
							    <text x="135" y="436" fill="black" transform="rotate(25, 135, 436)" style="font-weight:bold;font-size:13px;" opacity="0.9">FINANCE RISK</text>
							    <text x="29" y="201" fill="black" transform="rotate(90, 29, 201)" style="font-weight:bold;font-size:13px;" opacity="0.9">COMPLIANCE RISK</text>
							    <text x="134" y="57" fill="black" transform="rotate(342, 134, 57)" style="font-weight:bold;font-size:13px;" opacity="0.9">STRATEGIC RISK</text>
							    <text x="389" y="68" fill="black" transform="rotate(49, 389, 68)" style="font-weight:bold;font-size:13px;" opacity="0.9">OPERATION RISK</text> -->
	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="portlet light bordered">
			<div class="portlet-title tabbable-line">
				...
				<ul class="nav nav-tabs">
					<!-- <li class=""><a href="#tab_chart" data-toggle="tab" aria-expanded="false">Chart</a></li> -->
					<li class="active"><a href="#tab_rekapitulasi" data-toggle="tab" aria-expanded="true">Table</a></li>
				</ul>
					...
					<div class="tab-pane active" id="tab_rekapitulasi">
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								?>
							<?php 
							//begin hide kode coporate
							if ($rek['code'] == 'CORPORATE') {
...
$(document).ready(function () {
	$("#tahun_laporan_select").on('change', function(){
		var url = "<?php echo site_url('welcome/index_residual_worksheet').'?tahun='; ?>"+$(this).val();
