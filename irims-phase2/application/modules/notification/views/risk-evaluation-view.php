	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-table"></i>Risk Assessment Evaluation
				</div>
				<!--
				<div class="tools">
			...
			<div class="portlet-body">
							...
							<tr>
								...
								<td><?php
										if($mitigation){
											echo "<ol>";
											for ($i=0; $i <= count($mitigation)-1; $i++) { 
												if($mitigation[$i]->PIC_KANTOR_PUSAT_ID){
				...
				<div class="row">
					<div class="col-md-12">
						...
						<a href="<?php echo site_url('risk/risk_evaluation/index'); ?>" class="btn green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk/risk_evaluation/edit/' . $row->RISK_IDENTIFICATION_ID); ?>" class="btn green">UPDATE <i class="fa fa-pencil"></i></a> 
						<?php if(isset($row->RISK_ITEM_ID) AND $row->RISK_ITEM_ID > 0){?>
						<a href="<?php echo site_url('risk/risk_evaluation/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=3'); ?>" class="btn red">KONFIRMASI DAN KIRIM DOKUMEN KE RISK OWNER<i class="fa fa-send"></i></a>
						<?php }?>
						<?php }?>
					</div>
				</div>
