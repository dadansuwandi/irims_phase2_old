			...
			<div class="portlet-body">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<a href="<?php echo site_url('risk/risk_evaluation/mitigated'); ?>" class="btn green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a id="btn-reject" class="btn red">TOLAK / BELUM TERMITIGASI<i class="fa fa-times"></i></a>
						<a href="<?php echo site_url('risk/risk_evaluation/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=6'); ?>" class="btn blue">KONFIRMASI <i class="fa fa-check-square-o"></i></a>
						<?php }?>
					</div>
				</div>
			</div>
