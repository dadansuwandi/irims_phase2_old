			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="row">
						<div class="col-md-6">
							<div class="btn-group">
								<a href="<?php echo site_url('risk/risk_identification/add'); ?>" class="btn green">Buat Kertas Kerja<i class="fa fa-plus"></i></a>
							</div>
						</div>
						<!--
						<div class="col-md-6">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_6">
					...
					<tbody>
						...
						foreach ($rows as $row):
							...
							<tr>
								<td><?php echo $no++; ?></td>
								<td><a class="btn btn-block <?php echo $this->status_dokumen_model->get_by_id($row->STATUS_DOKUMEN_ID)->CSS_CLASS;?>" href="<?php echo site_url('risk/risk_identification/view/' . $row->RISK_IDENTIFICATION_ID); ?>"><?php echo $this->status_dokumen_model->get_by_id($row->STATUS_DOKUMEN_ID)->STATUS_DOKUMEN_NAMA; ; ?></a></td>
								<td>
									<?php
