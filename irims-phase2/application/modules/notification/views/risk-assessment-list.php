				...
				<table class="table table-striped table-bordered table-hover" id="sample_6">
					...
					<tbody>
						...
						foreach ($rows as $row):
							...
							<tr>
								<td><?php echo $no++; ?></td>
								<td><a class="btn btn-block <?php echo $this->status_dokumen_model->get_by_id($row->STATUS_DOKUMEN_ID)->CSS_CLASS;?>" href="<?php echo site_url('risk/risk_assessment/view/' . $row->RISK_IDENTIFICATION_ID); ?>"><?php echo $this->status_dokumen_model->get_by_id($row->STATUS_DOKUMEN_ID)->STATUS_DOKUMEN_NAMA; ; ?></a></td>
