		...
		<div class="portlet box green">
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="risk_identification_view">
					<thead>
						<tr>
							<th class="hidden-xs" rowspan="2">CODE</th>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<a href="<?php echo site_url('risk/risk_assessment/monitored_list'); ?>" class="btn green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk/risk_assessment/mitigation/'.$row->RISK_IDENTIFICATION_ID); ?>" class="btn green">INPUT MITIGASI<i class="fa fa-pencil"></i></a>
						<?php if(isset($row->MITIGASI_RISK_K_ID) AND $row->MITIGASI_RISK_K_ID>0){?>
						<a href="<?php echo site_url('risk/risk_assessment/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=5'); ?>" class="btn red">KONFIRMASI RISIKO<i class="fa fa-check-square-o"></i></a>
						<?php }?>
						<?php }?>
						...
						<a href="<?php echo site_url('risk/risk_assessment/mitigated_list'); ?>" class="btn green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<?php }?>
					</div>
				</div>
			</div>
