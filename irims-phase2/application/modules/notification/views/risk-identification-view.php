			...
			<div class="portlet-body">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<a href="<?php echo site_url('risk/risk_identification/index'); ?>" class="btn green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk/risk_identification/edit/' . $row->RISK_IDENTIFICATION_ID); ?>" class="btn green">UPDATE <i class="fa fa-pencil"></i></a> 
						<a href="<?php echo site_url('risk/risk_identification/delete/' . $row->RISK_IDENTIFICATION_ID); ?>" class="btn green" data-button="delete">DELETE <i class="fa fa-times"></i></a> 
						<a href="<?php echo site_url('risk/risk_identification/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=2'); ?>" class="btn red">SUBMIT DOKUMEN KE RISK ADMIN<i class="fa fa-send"></i></a>
						<?php }?>
						...
						<a href="<?php echo site_url('risk/risk_identification/index'); ?>" class="btn green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk/risk_identification/edit/' . $row->RISK_IDENTIFICATION_ID); ?>" class="btn green">UPDATE <i class="fa fa-pencil"></i></a>
						<a href="<?php echo site_url('risk/risk_identification/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=4'); ?>" class="btn red">KONFIRMASI RISIKO<i class="fa fa-check-square-o"></i></a>
						<?php }?>
					</div>
				</div>
			</div>
