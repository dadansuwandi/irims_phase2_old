			...
			<div class="portlet-body">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<a href="<?php echo site_url('risk_worksheet/risk_assessment_worksheet/monitored_list'); ?>" class="btn green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk_worksheet/risk_assessment_worksheet/mitigation/'.$row->RISK_IDENTIFICATION_ID); ?>" class="btn green">INPUT MITIGASI<i class="fa fa-pencil"></i></a>
						<?php if(isset($row->MITIGASI_RISK_K_ID) AND $row->MITIGASI_RISK_K_ID>0){?>
						<a href="<?php echo site_url('risk_worksheet/risk_assessment_worksheet/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=6'); ?>" class="btn red">KONFIRMASI RISIKO<i class="fa fa-check-square-o"></i></a>
						<?php }?>
						<?php }?>

						<?php if($row->STATUS_DOKUMEN_ID==7){?>
						<a href="<?php echo site_url('risk_worksheet/risk_assessment_worksheet/monitored_list'); ?>" class="btn green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk_worksheet/risk_assessment_worksheet/mitigation/'.$row->RISK_IDENTIFICATION_ID); ?>" class="btn green">INPUT MITIGASI<i class="fa fa-pencil"></i></a>
						<?php if(isset($row->MITIGASI_RISK_K_ID) AND $row->MITIGASI_RISK_K_ID>0){?>
						<a href="<?php echo site_url('risk_worksheet/risk_assessment_worksheet/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=6'); ?>" class="btn red">KONFIRMASI RISIKO<i class="fa fa-check-square-o"></i></a>
						...
						<!-- BUTTON STATUS MITIGATED -->
						<?php if($row->STATUS_DOKUMEN_ID==6){?>
						<a href="<?php echo site_url('risk_worksheet/risk_assessment_worksheet/mitigated_list'); ?>" class="btn green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<?php }?>
					</div>
				</div>
			</div>
