			...
			<div class="portlet-body">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<a href="<?php echo site_url('risk_worksheet/risk_evaluation_worksheet/index'); ?>" class="btn btn-circle green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk_worksheet/risk_evaluation_worksheet/edit/' . $row->RISK_IDENTIFICATION_ID); ?>" class="btn btn-circle green">UPDATE <i class="fa fa-pencil"></i></a> 
						<?php if(isset($row->RISK_ITEM_ID) AND $row->RISK_ITEM_ID > 0){?>
						<a href="<?php echo site_url('risk_worksheet/risk_evaluation_worksheet/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=3'); ?>" class="btn btn-circle red">KONFIRMASI DAN KIRIM DOKUMEN KE RISK OWNER<i class="fa fa-send"></i></a>
						<?php }?>
						<?php }?>

						<!-- BUTTON STATUS MITIGATED -->
						<?php if($row->STATUS_DOKUMEN_ID>=4){?>
						<a href="<?php echo site_url('risk_worksheet/risk_evaluation_worksheet/index'); ?>" class="btn btn-circle green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk_worksheet/risk_evaluation_worksheet/edit/' . $row->RISK_IDENTIFICATION_ID); ?>" class="btn btn-circle green">UPDATE <i class="fa fa-pencil"></i></a> 
						<a href="<?php echo site_url('risk_worksheet/risk_assessment_worksheet/mitigation/'.$row->RISK_IDENTIFICATION_ID); ?>" class="btn btn-circle green">INPUT MITIGASI<i class="fa fa-pencil"></i></a>
						
						<?php }?>

						<!-- BUTTON STATUS MITIGATED -->
						<?php if($row->STATUS_DOKUMEN_ID==4){?>
						<a href="<?php echo site_url('risk_worksheet/risk_evaluation_worksheet/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=6'); ?>" class="btn btn-circle blue">KONFIRMASI DAN CLOSE WORKSHEET<i class="fa fa-check-square-o"></i></a>
						<?php }?>
					</div>
				</div>
			</div>
