<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    /**
     * Risk Assessment Worksheet Controller.
     * 
     * @package App
     * @category Controller
     * @author Jaya Dianto
     */
    class risk_assessment_worksheet extends Admin_Controller {
    	...
    	function view($id) {
            ...
            $this->template->build('risk-assessment-worksheet-view');
        }
        ...
        function _updatedata($id = 0) {
            ...
            if(isset($_POST['MITIGASI_RISK_K_ID']) && isset($_POST['MITIGASI_RISK_D_ID'])){
                ...
                redirect('risk_worksheet/risk_evaluation_worksheet/view/'.$id);
            }
            ...
            $this->template
                ...
                ->build('risk-assessment-worksheet-form');
        }
      ...
      //   }
        ...
        function delete($id) {
            ...
            redirect('risk_worksheet/risk_assessment_worksheet');
        }
        ...
        function change_status(){
            if(isset($_GET['id']) && isset($_GET['status'])){
                ...
                if($_GET['status']==5){
                    ...
                    $notification['url']            = site_url('risk_worksheet/risk_evaluation/view_mitigated/'.$_GET['id']);
                    ...
                    redirect('risk_worksheet/risk_assessment_worksheet/monitored_list');
                }

                /*if($_GET['status']==6){
                    $this->template->set_flashdata('info', 'Dokumen telah diajukan ke risk admin untuk di evaluasi.');
                    redirect('risk_worksheet/risk_assessment_worksheet/mitigated_list');
                }*/
        ...
        function do_upload() {
          ...
          if (!$this->upload->do_upload()) {
              ...
              //     $foundFiles[$f]['deleteUrl'] = base_url() . 'index.php/risk_worksheet/risk_assessment_worksheet/deleteFile/' . $fileName;
              ...
              foreach ($existingFiles as $fileName => $info) {
                //if($fileName!='thumbs'){//Skip over thumbs directory
                  ...
                  $foundFiles[$f]['deleteUrl'] = base_url() . 'index.php/risk_worksheet/risk_assessment_worksheet/deleteFile/' . $info->FILE_NAME;
                  $foundFiles[$f]['deleteType'] = 'DELETE';
                  $foundFiles[$f]['error'] = null;
              ...
              $info->deleteUrl = base_url() . 'index.php/risk_worksheet/risk_assessment_worksheet/deleteFile/' . $data['file_name'];
              ...
              if (IS_AJAX) {
                  ...
                  $this->load->view('risk_worksheet/risk_assessment_worksheet/upload_success', $file_data);
              }
              ...
              if(isset($_POST['RISK_IDENTIFICATION_ID'])) {
                ...
                //redirect('risk_worksheet/risk_assessment_worksheet/mitigation/'.$_POST['RISK_IDENTIFICATION_ID']);
              } //else {
                //redirect('risk_worksheet/risk_assessment_worksheet/mitigation/'.$_POST['RISK_IDENTIFICATION_ID']);
              //}
          }
        ...
        function deleteFile($file) {//gets the job done but you might want to add error checking and security
          ...
          if (IS_AJAX) {
              ...
              $this->load->view('risk_worksheet/risk_assessment_worksheet/delete_success', $file_data);
          }
