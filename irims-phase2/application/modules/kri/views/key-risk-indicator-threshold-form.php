					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="threshold_acceptable" value="<?php echo !empty($threshold_acceptable) ? $threshold_acceptable : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="threshold_tolerable" value="<?php echo !empty($threshold_tolerable) ? $threshold_tolerable : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="text" name="threshold_unacceptable" value="<?php echo !empty($threshold_unacceptable) ? $threshold_unacceptable : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
                        <div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="number" step="any" name="nilai_awal" value="<?php echo !empty($nilai_awal) ? $nilai_awal : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-2">Simbol (isi dengan "<" atau ">")<span class="required">
							* </span>
							</label>
							<div class="col-md-9">
								<input type="text" name="simbol" value="<?php echo !empty($simbol) ? $simbol : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
                        <div class="form-group">
							...
							* </span>
							...
							<div class="col-md-9">
								<input type="number" step="any" name="nilai_akhir" value="<?php echo !empty($nilai_akhir) ? $nilai_akhir : ''; ?>" data-required="1" class="form-control"/>
							</div>
						</div>
						<div class="form-group">
