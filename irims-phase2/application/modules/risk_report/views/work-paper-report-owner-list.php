	...
	<div class="portlet-body form">
		...
		<form action="" method="POST" class="horizontal-form">
			...
			<div class="form-actions">
				...
				<a href="<?php echo site_url('risk_report/work_paper_report/owner'); ?>" class="btn default">Reset</a>
				<a href="<?php echo site_url('risk_report/work_paper_report/owner_pdf?tahun='.$_POST['tahun'].'&status='.$_POST['status'].'&risk_category_id='.$_POST['risk_category_id']); ?>" class="btn red">Export to PDF<i class="fa fa-file-pdf-o"></i></a> 
			</div>
		</form>
		<!-- END FORM-->
	</div>
				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<?php $temp++;} ?>
							<td><a href="<?php echo site_url('risk_report/work_paper_report/view/' . $d->RISK_IDENTIFICATION_ID .'/2'); ?>" target="_blank"><font color="blue"><?php echo $d->HAZARD?></font></a></td>
							<td>
								<?php
