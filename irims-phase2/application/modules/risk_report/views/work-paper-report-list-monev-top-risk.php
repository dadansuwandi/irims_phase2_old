					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="checkbox-list">
								<label><input type="checkbox" id="top_risk" name="top_risk" value="yes" checked> Yes </label>
							</div>
						</div>
					</div>
					<!--/span-->
			...
			<table class="table table-striped table-bordered table-hover" id="sample_1">
				<thead>
					<tr>
						...
						<th class="hidden-xs" colspan="5" style="background-color:#D6D9D2; text-align: center; vertical-align: middle; border-bottom: 1px solid black;">RENCANA PENANGANAN RISIKO</th>
						<th class="hidden-xs" colspan="7" style="background-color:#C9E0AB; text-align: center; vertical-align: middle; border-bottom: 1px solid black;">MONITORING & REVIEW</th>
					</tr>
					...
					<tr>
						...
						<th class="hidden-xs" colspan="2" style="background-color:#D6D9D2; text-align: center; vertical-align: middle;">RENCANA PENANGANAN RISIKO (Pencegahan dan/ atau Pemulihan)</th>
						<th class="hidden-xs" colspan="2" style="background-color:#D6D9D2; text-align: center; vertical-align: middle;">TARGET WAKTU</th>
						<th class="hidden-xs" rowspan="2" style="background-color:#D6D9D2; text-align: center; vertical-align: middle;">PIC</th>
						<th class="hidden-xs" rowspan="2" style="background-color:#C9E0AB; text-align: center; vertical-align: middle;">WAKTU PELAKSANAAN</th>
						<th class="hidden-xs" rowspan="2" style="background-color:#C9E0AB; text-align: center; vertical-align: middle;">KETERANGAN</th>
						<th class="hidden-xs" rowspan="2" style="background-color:#C9E0AB; text-align: center; vertical-align: middle;">TARGET TINGKAT KEMUNGKINAN</th>
						<th class="hidden-xs" rowspan="2" style="background-color:#C9E0AB; text-align: center; vertical-align: middle;">TARGET TINGKAT DAMPAK</th>
						<th class="hidden-xs" rowspan="2" style="background-color:#C9E0AB; text-align: center; vertical-align: middle;">LEVEL</th>
						<th class="hidden-xs" rowspan="2" style="background-color:#C9E0AB; text-align: center; vertical-align: middle;">R/M/T/E (Rendah/Menengah/Tinggi/Ekstrem)</th>
						<th class="hidden-xs" rowspan="2" style="background-color:#C9E0AB; text-align: center; vertical-align: middle;">KUANTIFIKASI</th>
					</tr>
					...
					<tr>
						...
						<th class="hidden-xs" style="background-color:#D6D9D2; text-align: center; vertical-align: middle;">KEMUNGKINAN</th>
						<th class="hidden-xs" style="background-color:#D6D9D2; text-align: center; vertical-align: middle;">DAMPAK</th>
						<th class="hidden-xs" style="background-color:#D6D9D2; text-align: center; vertical-align: middle;">MULAI</th>
						<th class="hidden-xs" style="background-color:#D6D9D2; text-align: center; vertical-align: middle;">SELESAI</th>
					</tr>
				</thead>
				<tbody>
					<?php
					...
					?>
						...
						<tr>
							...
							<td><?php echo $this->risk_pic_model->get_by_id($d->USER_PIC_ID)->name;?></td>
							<td>
								<?php
									if($mitigation){
										echo "<ol>";
