	...
	<div class="portlet-body form">
		...
		<form action="" method="POST" class="horizontal-form">
			...
			<div class="form-actions">
				...
				<a href="<?php echo site_url('risk_report/riskchart_map/index_mitigated'); ?>" class="btn default">Reset</a> 
				<!-- <a href="<?php //echo site_url('risk_report/riskchart_map/index_mitigated_pdf?tahun='.$_POST['tahun']); ?>" class="btn red">Export to PDF<i class="fa fa-file-pdf-o"></i></a>  -->
	...
	$("#pdfDownloader").click(function(){
        ...
        html2canvas(document.getElementById("printDiv"), {
            onrendered: function(canvas) {
                ...
                doc.save($.now()+'_riskchart_map_mitigated_list.pdf');
            }
        });
