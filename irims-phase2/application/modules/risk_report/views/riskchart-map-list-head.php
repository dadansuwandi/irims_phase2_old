	...
	<div class="portlet-body form">
		...
		<form action="" method="POST" class="horizontal-form">
			...
			<div class="form-actions">
				...
				<a href="<?php echo site_url('risk_report/riskchart_map/head'); ?>" class="btn default">Reset</a> 
				<!-- <a href="<?php //echo site_url('risk_report/riskchart_map/head_pdf?tahun='.$_POST['tahun']); ?>" class="btn red">Export to PDF<i class="fa fa-file-pdf-o"></i></a>  -->
