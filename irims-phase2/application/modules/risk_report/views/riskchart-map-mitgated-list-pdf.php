				...
				<tbody>
					...
					foreach ($rows as $row):
						...
						<tr>
							...
							<td><span class="label label-success"><?php echo $row['risk_k_monitoring']; ?></span></td>
							<td><span class="label label-warning"><?php echo $row['risk_d_monitoring']; ?></span></td>
							<td><span class="label label-info"><?php echo $row['risk_k_mitigated']; ?></span></td>
							<td><span class="label label-danger"><?php echo $row['risk_d_mitigated']; ?></span></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
				</table>
