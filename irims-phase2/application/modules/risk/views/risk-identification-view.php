	...
	<div class="col-md-12">
		...
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-table"></i>Risk Assessment
				</div>
				<!--
				<div class="tools">
			...
			<div class="portlet-body">
				...
				<div class="row">
					<div class="col-md-12">
						<!-- BUTTON STATUS DRAFT -->
						<?php if($row->STATUS_DOKUMEN_ID==1){?>
						<a href="<?php echo site_url('risk/risk_identification/index'); ?>" class="btn btn-circle green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk/risk_identification/edit/' . $row->RISK_IDENTIFICATION_ID); ?>" class="btn btn-circle green">UPDATE <i class="fa fa-pencil"></i></a> 
						<a href="<?php echo site_url('risk/risk_identification/delete/' . $row->RISK_IDENTIFICATION_ID); ?>" class="btn btn-circle green" data-button="delete">DELETE <i class="fa fa-times"></i></a> 
						<a href="<?php echo site_url('risk/risk_identification/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=2'); ?>" class="btn btn-circle red">SUBMIT DOKUMEN KE RISK ADMIN<i class="fa fa-send"></i></a>
						<?php }?>
						...
						<?php if($row->STATUS_DOKUMEN_ID==3){?>
						<a href="<?php echo site_url('risk/risk_identification/index'); ?>" class="btn btn-circle green"><i class="fa fa-chevron-left"></i> KEMBALI</a> 
						<a href="<?php echo site_url('risk/risk_identification/edit/' . $row->RISK_IDENTIFICATION_ID); ?>" class="btn btn-circle green">UPDATE <i class="fa fa-pencil"></i></a>
						<a href="<?php echo site_url('risk/risk_identification/change_status?id='.$row->RISK_IDENTIFICATION_ID.'&status=4'); ?>" class="btn btn-circle red">KONFIRMASI RISIKO<i class="fa fa-check-square-o"></i></a>
						<?php }?>
					</div>
				</div>
			</div>
