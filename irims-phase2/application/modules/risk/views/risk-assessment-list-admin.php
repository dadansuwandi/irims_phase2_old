<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
Risk <?php if ($this->uri->segment(3) == 'monitored_list_admin') { ?>
			Monitoring 
	<?php } else if ($this->uri->segment(3) == 'mitigated_list_admin') { ?>
			Mitigation 
	<?php } ?> 
</h3>
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="#">Risk  <?php if ($this->uri->segment(3) == 'monitored_list_admin') { ?>
			Monitoring 
	<?php } else if ($this->uri->segment(3) == 'mitigated_list_admin') { ?>
			Mitigation 
	<?php } ?> </a>
	...
	<div class="col-md-12">
		...
		<div class="portlet box blue-hoki">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-list"></i>Risk  <?php if ($this->uri->segment(3) == 'monitored_list_admin') { ?>
			Monitoring 
	<?php } else if ($this->uri->segment(3) == 'mitigated_list_admin') { ?>
			Mitigation 
	<?php } ?> 
