	...
	<div class="col-md-12">
		...
		<div class="portlet box red">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-table"></i>Additional
				</div>
			</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="portlet box blue" id="form_wizard_1">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i> Additional - <span class="step-title">
					Step 1 of 3 </span>
				</div>
			...
			<div class="portlet-body form">
				<form action="<?php echo site_url('risk/risk_backdate/saveWizard'); ?>" class="form-horizontal" id="risk_identification_form" data-redirect-url="<?php echo site_url('risk/risk_backdate/index')?>" method="POST">
						...
						<div class="form-body">
							<ul class="nav nav-pills nav-justified steps">
								<li>
									...
									1 </span>
									<span class="desc">
									<i class="fa fa-check"></i> Risk Identification & Analysis</span>
									</a>
								</li>
								<li>
									...
									2 </span>
									<span class="desc">
									<i class="fa fa-check"></i> Risk Evaluation</span>
									</a>
								</li>
								<li>
									...
									3 </span>
									<span class="desc">
									<i class="fa fa-check"></i> Risk Treatment & Risk Mitigation</span>
									</a>
								</li>
							</ul>
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="tab1">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Document Creator <span class="required">*</span></label>
										<div class="col-md-6">
											<select class="form-control select2me" name="INSERTED_BY">
												<?php foreach($CREATOR_ID as $key=>$val): ?>
												<?php if($key==$INSERTED_BY) { ?>
												<option value="<?php echo !empty($key) ? $key : ''; ?>" selected="selected"><?php echo !empty($val) ? $val : ''; ?></option>
												<?php } else { ?>
												<option value="<?php echo !empty($key) ? $key : ''; ?>"><?php echo !empty($val) ? $val : ''; ?></option>
												<?php } ?>
									...
									<div class="form-group">
										<label class="control-label col-md-3">Tahun Risk <span class="required">*</span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" name="TAHUN" value="<?php echo !empty($TAHUN) ? $TAHUN : ''; ?>"></input>
										</div>
									</div>
								...
								<div class="tab-pane" id="tab3">
									<div class="clonearea">
										<div class="clone hide">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<textarea class="form-control wysihtml5hidden" rows="6" name="RENCANA_PENGENDALIAN[]"><?php //echo !empty($RENCANA_PENGENDALIAN) ? $RENCANA_PENGENDALIAN : ''; ?></textarea>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<textarea class="form-control wysihtml5hidden" rows="6" required="required" name="REALISASI_MITIGASI[]"></textarea>
												</div>
											</div>
											...
											<div class="form-group">
		                                        ...
		                                        <div class="col-md-6">
		                                            <select class="form-control select2mehidden" name="PIC_UNIT_KERJA_ID[]" required="required">
		                                               	<?php 
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-md-6">
		                                            <select class="form-control select2mehidden" name="PIC_KANTOR_PUSAT_ID[]" required="required">
		                                                <?php 
										...
										<div id="clone_1" class="form_list">
											...
											<div class="form-group">
												<label class="control-label col-md-3">Realisasi Mitigasi <span class="required">*</span></label>
												<div class="col-md-6">
													<textarea class="form-control wysihtml5" rows="6" required="required" name="REALISASI_MITIGASI[]"></textarea>
												</div>
											</div>
											...
											<div class="form-group">
		                                        ...
		                                        <div class="col-md-6">
		                                            <select class="form-control select2me" name="PIC_UNIT_KERJA_ID[]" required="required">
		                                                <?php 
															echo $this->risk_pic_model->get_dropdown_pic_unit(false, false, false);	
														?>
		                                            </select>
		                                        </div>
		                                    </div>
									...
									<div class="form-group">
										<label class="control-label col-md-3">Risiko Termitigasi <span class="required">*</span></label>
										<div class="col-md-5">
											<select class="form-control select2me" name="TERMITIGASI" required="required">
												<option value="">-- Pilih Risiko Termitigasi --</option>
	                ...
	                $.ajax({
	                    ...
	                    success: function (response) {
	                        ...
	                        if(response.status=="failed"){
	                            ...
	                            $("#risk_identification_id_upload").val(response.RISK_IDENTIFICATION_ID);
