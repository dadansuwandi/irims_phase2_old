...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="#">Risk Assessment Update</a>
		</li>
	</ul>
</div>
<!-- END PAGE HEADER-->
	...
	<div class="col-md-12">
		...
		<div class="portlet box red">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-table"></i>Risk Assessment Update
				</div>
			</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="portlet box blue" id="form_wizard_1">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i> Risk Assessment Update - <span class="step-title">
					Step 1 of 3 </span>
				</div>
			...
			<div class="portlet-body form">
				<form action="<?php echo site_url('risk/risk_backdate/saveWizardUpdate'); ?>" class="form-horizontal" id="risk_identification_form" data-redirect-url="<?php echo site_url('report/risk_assessment_report/view/')?>" method="POST">
						...
						<div class="form-body">
							...
							<div class="tab-content">
								...
								<div class="tab-pane" id="tab3">
									...
									<div class="form-group">
										<div class="col-md-9">
											<a class="btn btn-sm blue pull-right" id="tambah-form">Tambah Form</a>
										</div>
									</div>
								</div>
							</div>
	                ...
	                $.ajax({
	                    ...
	                    success: function (response) {
	                        ...
	                        if(response.status=="failed"){
	                            ...
	                            if(redirect){
	                                window.location.href = redirect_url+"/"+response.RISK_IDENTIFICATION_ID+"/1";
	                            }
