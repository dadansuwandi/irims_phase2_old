							...
							<div class="tab-content">
								...
								<div class="tab-pane active" id="tab1">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" name="KPI" value="<?php echo !empty($KPI) ? $KPI : ''; ?>" class="form-control input-circle"/>
										</div>
									</div>
									<div class="form-group">
								...
								<div class="tab-pane" id="tab2">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<textarea class="form-control input-circle wysihtml5" readonly="readonly" rows="6" name="OBJECTIVE"><?php echo !empty($OBJECTIVE) ? $OBJECTIVE : ''; ?></textarea>
										</div>
									</div>
