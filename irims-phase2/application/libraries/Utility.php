...
class Utility {
    ...
    function format_date_notification($date){
        ...
        if($interval->y == 0 and $interval->m == 0 and $interval->d != 0){
            return $interval->d." days";
        }

        if($interval->y == 0 and $interval->m == 0 and $interval->d == 0 and $interval->h != 0){
            return $interval->h." hours";
        }

        if($interval->y == 0 and $interval->m == 0 and $interval->d == 0 and $interval->h == 0 and $interval->i != 0){
