...
if ( ! function_exists('form_uploadlabel'))
{
	/**
	 * Text Input Field with Label
	 * 
	 ...
	 * @uses _generate_input_label()
	 */
	function form_uploadlabel($name, $label, $required = FALSE, $value = '', $data = '')
	{
		return _generate_input_label('file', $name, $label, $required, $value, $data);
	}
}