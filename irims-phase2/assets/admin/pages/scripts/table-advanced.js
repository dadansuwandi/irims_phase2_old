var TableAdvanced = function () {
    ...
    var initTable3 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            var sOut = '<table>';
            sOut += '<tr><td>Frist Name:</td><td>' + aData[2] + '</td></tr>';
            sOut += '<tr><td>Last Name:</td><td>' + aData[3] + '</td></tr>';
            sOut += '<tr><td>Username:</td><td>' + aData[4] + '</td></tr>';
            sOut += '<tr><td>Email:</td><td>Could provide a link here</td></tr>';
            sOut += '</table>';
