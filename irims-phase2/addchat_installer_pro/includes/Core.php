...
class Core {
	...
	function transfer_files($data = [])
    {
        ...
        // 5. vendor
        $vendor_path                = 'application/vendor';
		$transfer[4]['source'] 		= 'src/vendor/';
		$transfer[4]['path']		= 'Vendor Path - '.$vendor_path;
		$transfer[4]['destination'] = '../'.$vendor_path.'/';
		$transfer[4]['file_check'] 	= 'autoload.php';
